...
import { useTrendingNowMovies } from "../../hooks/Movies/useTrendingNowMovies";
...
export function TrendingNow() {
	...
	const { data,
		fetchNextPage,
		hasNextPage,
		isFetchingNextPage, isLoading } = useTrendingNowMovies({
	...
	return (
		<section id={sectionLinks[ROUTES.MOVIES][4].id}>
