						...
						{data?.map((genre, index) => {
							...
							return (
								<CarouselSlide key={genre.id} className="basis-[180px] sm:basis-[calc((100%-40px)/3)] md:basis-[calc((100%-60px)/4)] lg:basis-[calc((100%-80px)/5)]">
									<CarouselCard to={ROUTES.TV_SHOWS_BY_GENRE_BY_ID(genre.id)} className="text-white p-5 flex flex-col gap-2 h-[clamp(201px,calc(5.743vw+178.6px),259px)] laptop:h-[clamp(259px,calc(17.292vw+10px),342px)]">
